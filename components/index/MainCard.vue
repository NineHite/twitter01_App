    ...
    <div class="main-content">
        <div class="content">
            ...
            <div class="content-tag">
                <div class="tag-main">
                    <div>
                        <h2 class="title-h2-inline">主页</h2>
                    </div>
                    <div class="t-svg">
                        <div>
                            <div>
            ...
            <!-- 发表 -->
            <tweet-edit :user="user"></tweet-edit>
            ...
            <div class="content-main">
                <div class="main-card">
                    ...
                    <article @click="$router.push('/tweet')">
                            ...
                            <div class="content-container">
                                ...
                                <div class="card-main">
                                                    ...
                                                    <el-popover
                                                        ...
                                                        <div class="main-name" slot="reference">
                                                            <a @click.stop href="#">
                                                                <div>Nine_Hite</div>
                                                                <div class="authentic"
                                                                     v-if="tweetInfo1.user.isAuthentic">
                                    ...
                                    <div>
                                        <div class="main-01">
                                            <p>
                                                姜糖苏叶饮  生姜5克苏叶5克切细丝放入瓷杯中，再加红糖15克，以沸水冲泡，盖上盖 浸泡10分钟趁热服 功效：解表散寒，行气宽中  应用：预防风寒型感冒，胃脘不适，怕冷等。
                                            </p>
                            ...
                            <div class="content-container">
                                ...
                                <div class="card-main">
                                    ...
                                    <div>
                                        <div class="main-01">
                                            <p>
                                                菊槐绿茶饮  生山楂菊花槐花绿茶各3-5克放入瓷杯中，以沸水冲泡，  盖上盖浸泡5分钟，频频饮用 功效：清热凉血，平肝熄风  应用：春夏季饮用，尤适用于高血压、冠心病等。
                                            </p>
                            ...
                            <div class="content-container">
                                ...
                                <div class="card-main">
                                    ...
                                    <div>
                                        <div class="main-01">
                                            <p>
                                                桑菊薄竹饮  桑叶菊花各5克竹叶白茅根各15-30克薄荷3克放入茶壶，沸水冲泡10分钟， 频饮或放冷后作饮料用。 功效：疏风、清热、除烦、明目 
                                                应用：夏季饮用、预防风热型感冒、目赤咽痛。
                                            </p>
                            ...
                            <div class="content-container">
                                ...
                                <div class="card-main">
                                    ...
                                    <div>
                                        <div class="main-01">
                                            <p>
                                                “Part of the anger and frustration is why have we not done this
                                                sooner…but here we are now and the question is do we have that perfect
                                                storm?”
                                            </p>
                            ...
                            <div class="content-container">
                                ...
                                <div class="card-main">
                                                    ...
                                                    <el-popover
                                                        ...
                                                        <div class="main-name" slot="reference">
                                                            <a href="#">
                                                                ...
                                                                <div class="uname main-detail">@JLMU</div>
                                                                <div class="main-detail"
                                                                     style="padding: 0 5px">·
                                                                </div>
                                                            </a>
                                    ...
                                    <div>
                                        <div class="main-01">
                                            <p>
                                                6月26日是国际禁毒日。国家禁毒委员会办公室提醒您：健康人生，绿色无毒。为了您和家人的健康幸福，请自觉抵制毒品侵害，积极参与禁毒斗争。
                                            </p>
                                            <div class="main-img" v-show="false">
                                                <el-image
                                                        src="/avatar/hand.jpg">
                            ...
                            <div class="content-container">
                                ...
                                <div class="card-main">
                                    ...
                                    <div>
                                        <div class="main-01">
                                            <p>
                                                姜糖饮 生姜10克饴糖15-30克（中药店有售，也可用关东糖代替）生姜切丝，放入瓷杯内，以沸水冲泡，盖上盖浸泡5分钟，再加入饴糖，频频代茶饮用。  功效：温胃和中，润肺止咳  应用：咳嗽咯痰，食欲不振，怕冷。秋冬季餐前代茶饮。
                                            </p>
...
<script>
    ...
    import TweetOps from "./TweetOps";
    import PopoverInfo from "./PopoverInfo";
    import Echarts from "../info/Echarts";
    import Testhb from "../info/Testhb";
                    ...
                    .t-svg {
                        ...
                        div {
                            ...
                            div {
                                ...
                                margin-right: calc(0px + (-1 * (41px - 1.5em)) / 2);
