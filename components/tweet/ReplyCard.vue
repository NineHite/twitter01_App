<template>
    <article id="reply-card">
        <div class="article-main">
            ...
            <div class="reply-card-content-container">
                ...
                <div class="left-avatar">
                    ...
                    <el-popover
                        ...
                        <!-- 弹框信息 -->
                        <popover-info :tweet="tweetInfo1"></popover-info>
                ...
                <div class="card-main">
                    <div class="card-main-title">
                        <div class="title-main">
                            <div class="main-left">
                                ...
                                <el-popover
                                    ...
                                    <div class="main-name" slot="reference">
                                        <a href="#">
                                            ...
                                            <div class="authentic" v-if="tweetInfo1.user.isAuthentic">
                                            ...
                                            <div class="uname main-detail">@Hiten_ine</div>
                                ...
                                <div class="main-detail">
                                    <a title="上午11:41 · 2020年5月20日" class="main-detail">8小时</a>
                                </div>
                            </div>
                            <div class="main-right">
                                ...
                                <el-popover
                                    ...
                                    <ul class="ul-li drop-down-font">
                                        <li>
                                            <div>
                                                <svg viewBox="0 0 24 24" height="1.25em" style="margin-right: 10px">
                                    ...
                                    <div slot="reference" class="hover-arrow">
                    ...
                    <div class="reply-card-to">
                        <div class="main-detail">回复</div>
                        <el-popover
                                :open-delay="500"
                                :close-delay="250"
                                :visible-arrow="false"
                            ...
                            <div class="main-name" slot="reference">
                                <a href="#">
                                    <span class="tweet-reply-to">@TheEconomist</span>
                                </a>
                            </div>
                        </el-popover>
                    </div>
...
<script>
    ...
    import TweetOps from "../index/TweetOps";
